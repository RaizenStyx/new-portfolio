...
export const HeroAnimation = () => (
  <div className="w-full h-full flex items-center justify-center opacity-80 md:opacity-100">
    <svg
      viewBox="0 0 602 602"
      fill="none"
      xmlns="http://www.w3.org/2000/svg"
      className="w-full h-auto max-w-[500px] md:max-w-[600px] animate-fade-in"
    >
      <g opacity="0.15">
        <path
          fillRule="evenodd"
