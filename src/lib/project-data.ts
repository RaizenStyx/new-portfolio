...
export const projects: Project[] = [
  // --- 1. FEATURED: Unreal Engine Games ---
  {
    id: "project-nebula",
    slug: "project-nebula",
    title: "Project Nebula",
    shortDescription: "An Action-RPG featuring a 3-star skill evolution system and a C++ backend.",
    fullDescription: "A complex Action-RPG currently in development. It features a robust C++ backend integrated seamlessly with modular Blueprint systems. Core architectural implementations include a dynamic 3-star skill-based evolution model—streamlined from a traditional class advancement system to improve development scoping and balance—alongside optimized state management for core gameplay loops.",
    techStack: ["Unreal Engine 5.5", "C++", "Blueprints", "Action-RPG Systems"],
    category: "Game Dev",
    featured: true,
    githubUrl: "https://github.com/RaizenStyx/Project_Nebula",
    imageUrl: "/images/nebula.png",
  },

  // --- 2. GAME DEV (Unreal & Prototypes) ---
  {
    id: "project-nightmare",
    slug: "project-nightmare",
    title: "Project Nightmare",
    shortDescription: "A survival game featuring dynamic grid-based crafting and resource gathering.",
    fullDescription: "A survival mechanics prototype focusing on player interaction and dynamic base building. Programmed a core building system that allows players to craft and snap walls, floors, and ceilings together within the environment. The project also features interactive world actors that facilitate resource gathering and inventory management.",
    techStack: ["Unreal Engine 5", "C++", "Blueprints", "Survival Systems"],
    category: "Game Dev",
    featured: true,
    githubUrl: "https://github.com/RaizenStyx/UE_Game_Project_Nightmare",
    imageUrl: "/images/nightmare.png",
  },
  {
    id: "project-portal",
    slug: "project-portal",
    title: "Project Portal",
    shortDescription: "Seamless portal mechanics and procedural terrain generation with projectile deformation.",
    fullDescription: "A technical showcase of advanced rendering and procedural generation. Developed functional, seamless portal mechanics using Render Targets to display remote environments dynamically. Additionally, the project features procedural terrain generation driven by Perlin noise algorithms, allowing for real-time mesh deformation triggered by projectile collisions.",
    techStack: ["Unreal Engine 5", "C++", "Blueprints", "Procedural Generation"],
    category: "Game Dev",
    featured: true,
    githubUrl: "https://github.com/RaizenStyx/Project_GAM415",
